...
Public Class frmRptVtasTipo
    ...
    Private Sub CalcularVentasDia()
        ...
        Sql = "SELECT  qty_0 * sns_0 AS cant, qty_0 * sns_0 * netpri_0 * ratcur_0 AS punit, amtnotlin_0 * sns_0 * ratcur_0 AS impii, accdat_0, rep1_0, qty_0 * sns_0 * pfm_0 * ratcur_0 AS margen, tsccod_1 "
        ...
        Sql &= "WHERE accdat_0 >= to_date(:datdeb1, 'dd/mm/yyyy') AND accdat_0 <= to_date(:datfin1, 'dd/mm/yyyy') AND sivtyp_0 <> 'PRF' AND (tsicod_1 = '108' and tsicod_2 = '201' and tsicod_3 = '301' and tsicod_4 = '594') "
        Sql &= "UNION ALL "
        Sql &= "SELECT qty_0 * sns_0 AS cant, qty_0 * sns_0 * netpri_0 * ratcur_0 AS punit, amtnotlin_0 * sns_0 * ratcur_0 AS impii, accdat_0, rep1_0, qty_0 * sns_0 * pfm_0 * ratcur_0 AS margen, tsccod_1 "
        Sql &= "FROM ((sinvoice siv INNER JOIN sinvoiced sid ON (siv.num_0 = sid.num_0)) INNER JOIN itmmaster itm ON (sid.itmref_0 = itm.itmref_0)) INNER JOIN bpcustomer bpc ON (siv.bpr_0 = bpc.bpcnum_0) "
        Sql &= "WHERE accdat_0 >=  to_date(:datdeb2, 'dd/mm/yyyy') AND accdat_0 <= to_date(:datfin2, 'dd/mm/yyyy') AND sivtyp_0 <> 'PRF' AND (tsicod_1 = '108' and tsicod_2 = '201' and tsicod_3 = '301' and tsicod_4 = '594') "
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        rpt.Load(RPTX3 & "XRPTVTASTIPO.rpt") 'Reporte normal
        rpt.SetParameterValue("X3TIT", "Ventas por tipo de cliente Matafuegos 5 ABC")
    ...
    Private Sub frmRptVtasTipo_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
            If rpt IsNot Nothing Then rpt.Dispose()
