...
Public Class frmRptVtasfliaA
    ...
    Private Sub ObtenerVentas()
        ...
        Sql &= "       itm.tsicod_3, itm.tsicod_4, accdat_0, rep1_0, sid.itmref_0, tsccod_1 as flia "
    ...
    Private Sub ObtenerVentasExtintor()
        ...
        Sql = "SELECT EXTRACT(MONTH FROM accdat_0) AS MES, itm.tsicod_4, itm.tsicod_2, itm.tsicod_1, sum(qty_0 * sns_0) AS cant  "
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        If rbRpt1.Checked Then
            rpt.Load(RPTX3 & "XRPTVTASFLIAA.rpt")
