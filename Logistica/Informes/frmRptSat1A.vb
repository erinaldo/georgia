...
Public Class frmRptSat1A
    ...
    Private Sub ObtenerVentas()
        ...
        Sql = "SELECT  qty_0 * sns_0 AS cant, qty_0 * sns_0 * netpri_0 * ratcur_0 AS punit, amtatilin_0 * sns_0 * ratcur_0 AS impii, accdat_0, rep1_0, sat_0 "
        ...
        Sql &= "WHERE EXTRACT(YEAR FROM accdat_0) = :dat AND sivtyp_0 <> 'PRF' AND tsccod_1 = '20' "
        ...
        For Each dr In dt.Rows
            ...
            If IsVendedorCheck(dr("rep1_0").ToString) Then
                ...
                'Filtro la provincia a la que voy a sumar las cantidades
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        rpt.Load(RPTX3 & "XRPTSAT1A.rpt")
        rpt.SetParameterValue("X3TIT", "Ventas por provincias del año")
    ...
    Private Sub frmRptSat1A_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
            If rpt IsNot Nothing Then rpt.Dispose()
