...
Public Class frmRptVtasTipoA
    ...
    Private Sub btnGenerar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGenerar.Click
        ...
        rpt.SetParameterValue("X3TIT", "Ventas por tipo de cliente del año MATAFUEGOS 5 ABC")
    ...
    Private Sub ObtenerVentas()
        ...
        Sql = "SELECT  qty_0 * sns_0 AS cant, qty_0 * sns_0 * netpri_0 * ratcur_0 AS punit, amtnotlin_0 * sns_0 * ratcur_0 AS impii, accdat_0, rep1_0, tsccod_1 "
        Sql &= "FROM (sinvoice siv INNER JOIN sinvoiced sid ON (siv.num_0 = sid.num_0)) INNER JOIN bpcustomer bpc ON (siv.bpr_0 = bpc.bpcnum_0) "
        Sql &= "WHERE EXTRACT(YEAR FROM accdat_0) = :dat AND sivtyp_0 <> 'PRF' "
        Sql &= "AND (tsicod_1 = '108' and tsicod_2 = '201' and tsicod_3 = '301' and tsicod_4 = '594')"
        Sql &= "ORDER BY accdat_0"
    ...
    Private Sub frmRptVtasTipoA_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        Try
            If rpt IsNot Nothing Then rpt.Dispose()
