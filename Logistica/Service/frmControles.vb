...
Public Class frmControles
    ...
    'Function
    Private Function company(ByVal bpc As String) As String
        Dim dr As DataRow
        ...
        If dt.Rows.Count > 0 Then
            ...
            If dr("salfcy_0").ToString = "D01" Then
                compania = "DNY"
                'ElseIf dr("salfcy_0").ToString = "M01" Then
                '    compania = "GRU"
                'ElseIf dr("salfcy_0").ToString = "G01" Then
                '    compania = "GRU"
            Else
                compania = "LIA"
            End If
        ...
        Else
            ...
            If dt1.Rows.Count > 1 Then
                ...
                If dr1("salfcy_0").ToString = "D01" Then
                    compania = "DNY"
                    'ElseIf dr1("salfcy_0").ToString = "M01" Then
                    '    compania = "GRU"
                    'ElseIf dr1("salfcy_0").ToString = "G01" Then
                    '    compania = "GRU"
                Else
                    compania = "LIA"
                End If
